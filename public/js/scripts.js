(function ($) {
    ...
    $('.copy-email').click(function (e) { e.preventDefault() });
    ...
    copyEmailBtn.addEventListener('click', function (event) {
        copyTextToClipboard('nicholasmordecai@gmail.com');
        $("#email-copy-result").show().animate({ opacity: 1.0, top: '-180%'}, 1750, 'swing', function() {
            $("#email-copy-result").hide();
            $("#email-copy-result").css('top', '-70%');
        });
    });
